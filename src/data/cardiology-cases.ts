...
const guidelineLibrary = '/guidelines';
...
const coreCardiologyCases: CardiologyCase[] = [
  {
    ...
    stages: [
      ...
      },
      {
        ...
        media: { type: 'ecg', src: '/ecg-tracings/inferior-mi/02792.png', alt: '12-lead ECG from the inferior myocardial infarction library', href: '/ecg/tracing/2792' },
      },
      {
